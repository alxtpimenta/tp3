		...
		if(jogador.getPreso() == true)
		{
                  ...
                  //PREPARAR PARA ESPERAR ACAO DO JOGADOR
                    ...
                    if(modoHabeasCorpus)
                    {
                        ...
                        UserInterface.Dialogo.avisoGenerico("Voce utilizou sua carta de habeas corpus e saiu da pris縊. Jogue normalmente na proxima rodada!");
